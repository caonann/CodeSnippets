...
class test_obj {
 public:
  ...
  test_obj() { cout << __func__ << " default constructed" << endl; }
  ...
  ~test_obj() { cout << __func__ << " destructed" << endl; }

  static void show_i() { printf("constructer calls %d times\n", i); }
...
test_obj returnRvalueTest() { return test_obj(0, "abc"); }
...
void test_case3() { test_obj::show_i(); }
